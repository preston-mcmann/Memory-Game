 ...
 * @author ahuyn9
 */
public class EditSets extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditSets.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
